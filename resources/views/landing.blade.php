...
@section('content')
    ...
    <section class="container min-h-[90vh] relative mt-28">
      ...
      >
        <div class="px-4 md:pl-12 w-full lg:w-1/2 lg:portrait:w-full">
          ...
          <span
            ...
            >Menanamkan nilai Islam dan ilmu sejak dini untuk melahirkan generasi yang berprestasi dan berkarakter.</span
          >
        </div>
        <img
          src="../assets/images/fotodpn.png"
      ...
      >
        ...
        <img
          src="../assets/images/fotodpan1.png"
          class="mr-12 sm:-mr-12 z-0 w-full lg:w-1/2 lg:portrait:w-4/5"
          alt="Hero Image"
        />
      </div>
      ...
      >
        ...
        <img
          src="../assets/images/fotodpan2.png"
          class="mr-12 sm:-mr-12 z-0 w-full lg:w-1/2 lg:portrait:w-4/5"
          alt="Hero Image"
        />
      </div>
