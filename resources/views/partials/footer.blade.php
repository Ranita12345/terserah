...
<footer class="w-full mt-14 pt-20">
        ...
        <div>
            <img
            class="mb-10"
            src="{{ optional($datafooter)->image ? Storage::url($datafooter->image) : asset('assets/images/footer.png') }}"
            ...
            <a
                href="{{ $datafooter->link_instagram ?? 'https://share.google/vX4n3icNGDyajQh0p' }}"
                class="w-8 h-8 grid place-content-center rounded-full bg-primary-200"
            >
                <i class="bi bi-instagram text-lg text-xneutral-0"></i>
            </a>
            <a
                href="{{ $datafooter->link_youtube ?? 'https://www.youtube.com/@nawwir_quluubanaa' }}"
                class="w-8 h-8 grid place-content-center rounded-full bg-primary-200"
            >
        ...
        <div>
            ...
            <div class="flex gap-4">
                ...
                <p class="font-poppins text-xneutral-200 text-sm">
                    {{ $datafooter->alamat ?? ' Belakang Kampus FITK UNSIQ, PPTQ Nawwir Quluubanaa, Jl. Raya Kalibeber No.11, Kemiri, Sukorejo, Kec. Mojotengah, Kabupaten Wonosobo, 56351' }}
                </p>
            </div>
            <div class="flex gap-4">
        ...
        <div>
            ...
            <div class="max-h-24">
            <a href="{{ $datafooter->link_gmaps ?? 'https://maps.app.goo.gl/obbQdEWaB5tw4LyH7' }}" target="_blank" rel="noopener noreferrer">
        ...
        <p class="text-center my-6 font-poppins text-xneutral-200">
            Copyright © 2025 | Nawwir Quluubanaa – Wonosobo
        </p>
        </div>
</footer>
